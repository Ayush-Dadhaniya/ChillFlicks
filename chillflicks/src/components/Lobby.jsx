...
const Lobby = () => {
  ...
  <div className="flex flex-col lg:flex-row gap-6 justify-center items-start">
    ...
    <div className="w-full lg:w-2/3">
      <div id="youtube-player" className="aspect-video w-full rounded-xl shadow-cyan-200" />
      <button
        onClick={handlePlayPause}
        className="mt-4 px-6 py-2 text-white font-semibold rounded-full bg-gradient-to-r from-[#ff00ff] to-[#7f00ff] hover:from-[#00d0dd] hover:to-[#6a00cc] shadow-lg transition"
      >
    ...
    <div className="w-full lg:w-1/3 flex flex-col gap-6">
      ...
      <div className="bg-[#1a1a1a] border border-[#7f00ff] rounded-lg p-4 shadow-[0_0_10px_#00f0ff]">
        <h3 className="text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#ff00ff] to-[#7f00ff] mb-2">Chat</h3>
        <div className="h-64 overflow-y-auto space-y-2 scrollbar-thin scrollbar-thumb-[#00f0ff] mb-3 px-1">
          {messages.map((msg, i) => (
            <div key={i} className="bg-[#00f0ff22] p-2 rounded-md">
              <strong className="text-[#00f0ff]">{msg.user}</strong>: {msg.text}
        ...
        <div className="flex">
          <input
            className="flex-grow p-2 bg-[#121212] border border-[#00f0ff] rounded-l-md text-white"
            value={newMessage}
      ...
      <div className="bg-[#1a1a1a] border border-[#00f0ff] rounded-lg p-4 shadow-[0_0_10px_#00f0ff]">
        <h3 className="text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#00f0ff] to-[#7f00ff] mb-2">Participants</h3>
